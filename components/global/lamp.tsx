  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="text-[2.5rem] -translate-y-20 font-bold bg-gradient-to-r from-gray-300 via-white to-gray-300 bg-clip-text text-transparent drop-shadow-xl text-center"
      >
          Powering Automation with Precision
      </motion.h1>
    </LampContainer>
  )
}
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[10rem] bg-neutral-400 "
        ></motion.div>

        <div className="w-[40rem] h-40 relative -translate-y-[9rem]">
          <SparklesCore
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[15.5rem] bg-neutral-950 "></div>
      </div>
