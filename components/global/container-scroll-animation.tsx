...
export const Card = ({ rotate, scale, translate, }: {
    ...
    style={{
        ...
        <div className="bg-gray-100 h-full w-full rounded-2xl relative gap-4 p-4 transition-all ">
        <Image src="/temp-banner.png" fill alt="bannerImage" className="w-full h-full object-cover border-8 rounded-2xl"/>
        </div>
    </motion.div>
    )
}